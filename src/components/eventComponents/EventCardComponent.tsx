...
const EventCardComponent = ({ event }: Props) => {
  ...
  return (
    <div className='flex flex-col rounded-lg p-4 space-y-2 bg-lightGreen'>
      ...
      <p className='text-gray'>{event.startDateTime.toDateString()}</p>
      <p className='text-gray'>{event.endDateTime.toDateString()}</p>
