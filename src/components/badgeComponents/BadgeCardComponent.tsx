...
const BadgeCardComponent = ({ badge }: Props) => {
    ...
    return (
    <Link className='flex flex-col rounded-lg p-4 space-y-2 bg-lightGreen' href={"/badges/${badges.id}"}>
        <Image src={image} alt={badge.name} width={200} height={200} className='w-[150px] h-[50px] rounded-lg' />
