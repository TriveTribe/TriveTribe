...
const SettingsPage: React.FC = () => {
    return (
        <div className="container mx-auto mt-10 px-4">
            ...
            <form>
                <div className="mb-4">
                    <label htmlFor="name" className="block font-bold mb-1">Username</label>
                ...
                <div className="mb-4">
                    ...
                    <label htmlFor="notifications" className="font-bold">Receive Notifications</label>
                </div>
                <div className="mb-4">
                    <label htmlFor="timezone" className="block font-bold mb-1">Timezone</label>
                    <select id="timezone" name="timezone" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
                ...
                <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Save Settings</button>
            </form>
        </div>
    );
}
