 ...
 */
export const createBadgesReceived = async (createBadgeReceivedModel: CreateBadgesReceivedModel) => {
  try {
    ...
    throw new Error("Error creating badgesReceived, please check fields and try again.");
  }
};
